...
UPLOAD_FILES = [
    ...
    "macro_event_clusters_dabento_1m.csv",
    "macro_event_clusters_dabento_5m.csv",
    "macro_event_clusters_dabento_60m.csv",
    "macro_event_clusters_dabento_60m_long.csv",
    "macro_event_clusters_dabento_full_1m.csv",
    "macro_event_clusters_dabento_full_5m.csv",
    "macro_event_clusters_dabento_full_60m.csv",
    "macro_event_clusters_investing_daily.csv",
    "macro_event_clusters_yahoo_daily.csv",
    ...
    "macro_reactions_dabento_1m.csv",
    "macro_reaction_profiles_dabento_1m.csv",
    "macro_reactions_dabento_5m.csv",
    "macro_reaction_profiles_dabento_5m.csv",
    "macro_reactions_dabento_60m.csv",
    "macro_reaction_profiles_dabento_60m.csv",
    "macro_reactions_dabento_60m_long.csv",
    "macro_reaction_profiles_dabento_60m_long.csv",
    "macro_reactions_dabento_full_1m.csv",
    "macro_reaction_profiles_dabento_full_1m.csv",
    "macro_reactions_dabento_full_5m.csv",
    "macro_reaction_profiles_dabento_full_5m.csv",
    "macro_reactions_dabento_full_60m.csv",
    "macro_reaction_profiles_dabento_full_60m.csv",
    "macro_reactions_investing_daily.csv",
    "macro_reaction_profiles_investing_daily.csv",
    "macro_reactions_yahoo_daily.csv",
    "macro_reaction_profiles_yahoo_daily.csv",
    "macro_daily_source_comparison.csv",
    "macro_daily_source_comparison_groups.csv",
    "macro_daily_source_comparison_report.json",
    ...
    "dabento_nq_adapter_report.json",
    "dabento_nq_60min_long_adapter_report.json",
    "dabento_nq_full_adapter_report.json",
    "NQ_dabento_roll_map.csv",
    "NQ_dabento_60min_long_roll_map.csv",
    "NQ_dabento_full_roll_map.csv",
    "market_data_source_reconciliation_investing_vs_yahoo.csv",
    "market_data_source_reconciliation_investing_vs_yahoo_report.json",
    "news_summary.csv",
    "NQ_investing_daily_clean_candidate.csv",
    "NQ_1min_data.csv",
    "NQ_5min_data.csv",
    "NQ_15min_data.csv",
    "NQ_60min_data.csv",
...
UPLOAD_PATTERNS = [
    ...
    "market_data_verification_investing_*_report.json",
    "market_data_verification_investing_*_summary.csv",
    "market_data_verification_dabento_*_report.json",
    "market_data_verification_dabento_*_summary.csv",
]
