...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-1m", default="data/NQ_dabento_1min_data.csv")
    p.add_argument("--out-5m", default="data/NQ_dabento_5min_data.csv")
    p.add_argument("--out-60m", default="data/NQ_dabento_60min_data.csv")
    p.add_argument("--roll-map-output", default="data/NQ_dabento_roll_map.csv")
